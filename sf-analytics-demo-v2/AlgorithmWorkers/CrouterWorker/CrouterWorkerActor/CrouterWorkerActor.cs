...
using CrouterAlgorithm;
using CrouterWorkerActor.Interfaces;
using CrouterWorkerActor.Logic;
...
namespace CrouterWorkerActor
{
    ...
    internal class CrouterWorkerActor : Actor, ICrouterWorkerActor
    {
        ...
        private ICrouterWorkerLogic _crouterWorkerLogic;
        private IAnalyticsJobsService _analyticsJobsService;
        /// <summary>
        /// Initializes a new instance of CrouterWorkerActor
        /// </summary>
        /// <param name="actorService">The Microsoft.ServiceFabric.Actors.Runtime.ActorService that will host this actor instance.</param>
        /// <param name="actorId">The Microsoft.ServiceFabric.Actors.ActorId for this actor instance.</param>
        public CrouterWorkerActor(ActorService actorService, ActorId actorId) 
        ...
        protected override Task OnActivateAsync()
        {
            ...
            _crouterWorkerLogic = new CrouterWorkerLogic(new CrouterCutpointService(), FabricServices.GetCrouterStorageService());
        ...
        public async Task<AlgorithmWorkerTaskResult> ProcessAlgorithm()
        {
            ...
            try
            {
                ...
                var itemsCompleted = await _crouterWorkerLogic.ProcessCounts(countsArry, subjectId, deviceId, taskId, settingsId);
