...
using DustinTracyWorkerActor.Logic;
...
namespace DustinTracyWorkerActor
{
    /// <remarks>
    ...
    internal class DustinTracyWorkerActor : Actor, IDustinTracyWorkerActor
    {
        ...
        public IDustinTracyWorkerLogic _dustinTracyWorkerLogic;
        private IAnalyticsJobsService _analyticsJobsService;
        /// <summary>
        /// Initializes a new instance of DustinTracyWorkerActor
        /// </summary>
        /// <param name="actorService">The Microsoft.ServiceFabric.Actors.Runtime.ActorService that will host this actor instance.</param>
        /// <param name="actorId">The Microsoft.ServiceFabric.Actors.ActorId for this actor instance.</param>
        public DustinTracyWorkerActor(ActorService actorService, ActorId actorId)
        ...
        protected override Task OnActivateAsync()
        {
            ...
            _dustinTracyWorkerLogic = new DustinTracyWorkerLogic(new DustinTracySleepTimeService(), FabricServices.GetAlgorithmStateService(), FabricServices.GetDustinStorageService());
        ...
        public async Task<AlgorithmWorkerTaskResult> ProcessAlgorithm()
        {
            ...
            try
            {
                ...
                var itemsCompleted = await _dustinTracyWorkerLogic.ProcessRecords(countsArry, subjectId, deviceId, settings, taskId, settingsId);
            ...
            workerResult.ProcessingEndedUtc = DateTime.UtcNow;
