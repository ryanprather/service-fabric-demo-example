...
namespace CountsWorkerActor
{
    ...
    internal class CountsWorkerActor : Actor, ICountsWorkerActor
    {
        ...
        private ICountsWorkerLogic _countsWorkerLogic;
        private IAnalyticsJobsService _analyticsJobsService;
        /// <summary>
        /// Initializes a new instance of CountsWorkerActor
        /// </summary>
        /// <param name="actorService">The Microsoft.ServiceFabric.Actors.Runtime.ActorService that will host this actor instance.</param>
        /// <param name="actorId">The Microsoft.ServiceFabric.Actors.ActorId for this actor instance.</param>
        public CountsWorkerActor(ActorService actorService, ActorId actorId)
        ...
        protected override Task OnActivateAsync()
        {
            ...
            _countsWorkerLogic = new CountsWorkerLogic(FabricServices.GetCountsStorageService());
        ...
        public async Task<AlgorithmWorkerTaskResult> ProcessAlgorithm()
        {
            ...
            try 
            {
                ...
                var itemsCompleted = await _countsWorkerLogic.ProcessCounts(countsArry, subjectId, deviceId, taskId, settingsId);
